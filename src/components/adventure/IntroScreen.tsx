  ...
  return (
    <div className="flex flex-1 flex-col items-center justify-between pb-4 pt-3 text-center animate-pop">
      <div className="w-full">
        <div className="mx-auto inline-flex rounded-none bg-card/85 px-4 py-2 font-display text-[9px] uppercase tracking-[0.35em] text-game-ink shadow-soft pixel-border">
          {adventure.brandName}
        </div>
        <div className="pixel-border relative mx-auto mt-4 max-w-sm rounded-none bg-[linear-gradient(180deg,hsl(var(--wood-light))_0%,hsl(var(--wood))_100%)] px-4 py-5 shadow-pixel">
          ...
          <h1 className="pixel-text font-display text-2xl leading-relaxed text-game-cream sm:text-3xl">
            {adventure.title}
          </h1>
      ...
      <div className="relative mt-5 w-full flex-1">
        <div className="pixel-border relative mx-auto h-[27rem] overflow-hidden rounded-none shadow-pixel">
          <SelectionScene />
          <div className="absolute inset-x-0 top-0 h-32 bg-[linear-gradient(180deg,rgba(10,14,27,0.22),transparent)]" />
          <div className="absolute inset-x-0 bottom-0 h-28 bg-[linear-gradient(180deg,transparent,rgba(10,14,27,0.20))]" />
        </div>
      </div>

      <div className="w-full max-w-sm space-y-3">
        <div className="pixel-border rounded-none bg-game-ink/92 px-4 py-3 text-game-cream shadow-pixel">
          <p className="font-display text-[10px] uppercase tracking-[0.35em] text-accent">READY PLAYER LOVE</p>
